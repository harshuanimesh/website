...
exports.employeeRouter.get("/", (_req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const employees = yield database_1.collections.employees
        .find({})
        .toArray();
...
exports.employeeRouter.get("/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
      const id =
...
exports.employeeRouter.post("/", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.employeeRouter.put("/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _c;
    try {
      const id =
      ...
      const employee = req.body;
      const query = { _id: new mongodb.ObjectId(id) };
      const result = yield database_1.collections.employees.updateOne(query, {
        $set: employee,
      });
...
exports.employeeRouter.delete("/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _d;
    try {
      const id =
